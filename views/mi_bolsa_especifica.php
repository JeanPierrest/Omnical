...
<div class="container">
    ...
    <div class="filtro-bar">
        ...
        <button class="btn-filtro" onclick="filtrar('RETORNO EXTERNO', this)">🔄 Retorno Externo</button>
            ...
            <?php if (empty($tickets)): ?>
                <tr>
                    <td colspan="7" style="text-align:center; padding:30px; color:var(--text-muted);">
                        No tienes casos derivados a ti actualmente.
                    </td>
                </tr>
            <?php else: ?>
...
<script>
    ...
    function abrirModalVistaPrevia(boton) {
        ...
        // Reset del historial cada vez que se abre el modal con otro ticket
